                  ...
                  (index) => GestureDetector(
                        onTap: () {
                          Get.toNamed('/imageViewer',
                              arguments: ServerConfig.DNS +
                                  '/' +
                                  controller.image[index].path +
                                  '/' +
                                  controller.image[index].name);
                        },
                        child: CachedNetworkImage(
                          imageUrl:
                              "${Uri.parse("${Uri.parse(ServerConfig.DNS + '/' + controller.image[index].path + '/' + controller.image[index].name)}")}",
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      launchUrl(Uri.parse("tel://${controller.userNumber}"));
                    },
                    child: Text(controller.userNumber,
                        style: TextStyle(color: textColor, fontSize: 13)),
                  ),
                ],
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        controller.des,
                        style: TextStyle(
                            fontSize: 16, fontFamily: 'ca1', color: textColor),
                      ),
                      Text(
                        'السعر',
                        style: TextStyle(
                            fontSize: 25, fontFamily: 'ca1', color: textColor),
                      ),
                      Text(
                        controller.price,
                        style: TextStyle(
